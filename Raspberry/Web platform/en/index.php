...
<html lang="en">
    ...
    <head>
        ...
        <title>Data logger - Low Current</title>
    ...
    <body class="skin-blue fixed-layout" oncontextmenu="return false">
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Data logger v2.0 - Low Current</p>
            </div>
        </div>
        <div id="main-wrapper">
            <header class="topbar">
                        ...
                        <div class="col-md-7 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Low Current</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex no-block align-items-center">
                                            <div>
                                                ...
                                                <p class="text-danger" id="batterietitle">BATTERY</p>
                                            </div>
                                            <div class="ml-auto">
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex no-block align-items-center">
                                            <div>
                                                ...
                                                <p class="text-danger" id="voltagedctitle">DC VOLTAGE</p>
                                            </div>
                                            <div class="ml-auto">
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex no-block align-items-center">
                                            <div>
                                                ...
                                                <p class="text-danger" id="currentdctitle">DC CURRENT</p>
                                            </div>
                                            <div class="ml-auto">
                                        ...
                                        <div class="d-flex no-block align-items-center">
                                            <div>
                                                <h3><i class="fas fa-fire"></i></h3>
                                                    <p class="text-danger" id="puissancedctitle">DC POWER</p>
                                            </div>
                                            <div class="ml-auto">
