...
<html lang="en">
    ...
    <head>
        ...
        <title>Data logger - Maison intelligente</title>
    ...
    <body class="skin-blue fixed-layout" oncontextmenu="return false">
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Data logger v2.0 - Maison intelligente</p>
            </div>
        </div>
        <div id="main-wrapper">
            <header class="topbar">
                        ...
                        <div class="col-md-7 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Maison intelligente</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex no-block align-items-center">
                                            <div>
                                                ...
                                                <p class="text-danger" id="lighttitle">Lumière</p>
                                            </div>
                                            <div class="ml-auto">
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex no-block align-items-center">
                                            <div>
                                                ...
                                                <p class="text-danger" id="doortitle">PORTE PRINCIPALE</p>
                                            </div>
                                            <div class="ml-auto">
                                                <h3 class="counter text-danger" id="door">FERMÉE</h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="d-flex no-block align-items-center">
                                            <div>
                                                <h3><i class="far fa-window-maximize"></i></h3>
                                                    <p class="text-danger" id="windowtitle">FENÊTRE</p>
                                            </div>
                                            <div class="ml-auto">
                                                <h3 class="counter text-danger" id="window">FERMÉE</h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="d-flex no-block align-items-center">
                                            <div>
                                                <h3><i class="fas fa-snowflake"></i></h3>
                                                    <p class="text-danger" id="actitle">CLIMATISEUR</p>
                                            </div>
                                            <div class="ml-auto">
                                        ...
                                        <div class="d-flex no-block align-items-center">
                                            <div>
                                                <h3><i class="fas fa-fan"></i></h3>
                                                    <p class="text-danger" id="acfantitle">VENTILATEUR</p>
                                            </div>
                                            <div class="ml-auto">
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex no-block align-items-center">
                                            <div>
                                                ...
                                                <p class="text-danger" id="ldrfluxtitle">FlUX LUMINEUX</p>
                                            </div>
                                            <div class="ml-auto">
                                        ...
                                        <div class="d-flex no-block align-items-center">
                                            <div>
                                                <h3><i class="fas fa-cloud"></i></h3>
                                                    <p class="text-danger" id="gauzesleveltitle">NIVEAU DES GAZES</p>
                                            </div>
                                            <div class="ml-auto">
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex no-block align-items-center">
                                            <div>
                                                ...
                                                <p class="text-danger" id="extractortitle">EXTRACTEUR</p>
                                            </div>
                                            <div class="ml-auto">
                                        ...
                                        <div class="d-flex no-block align-items-center">
                                            <div>
                                                <h3><i class="fas fa-male"></i></h3>
                                                    <p class="text-danger" id="movetitle">MOUVEMENT</p>
                                            </div>
                                            <div class="ml-auto">
                                                <h3 class="counter text-danger" id="movement">NON</h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex no-block align-items-center">
                                            <div>
                                                ...
                                                <p class="text-danger" id="tempexttitle">TEMPÉRATURE EXT</p>
                                            </div>
                                            <div class="ml-auto">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="d-flex no-block align-items-center">
                                            <div>
                                                <h3><i class="fas fa-thermometer-three-quarters"></i></h3>
                                                <p class="text-danger" id="tempinttitle">TEMPÉRATURE INT</p>
                                            </div>
                                            <div class="ml-auto">
                                        ...
                                        <div class="d-flex no-block align-items-center">
                                            <div>
                                                <h3><i class="fas fa-tint"></i></h3>
                                                    <p class="text-danger" id="inthumiditytitle">HUMIDITÉ RELATIVE</p>
                                            </div>
                                            <div class="ml-auto">
                                        ...
                                        <div class="d-flex no-block align-items-center">
                                            <div>
                                                <h3><i class="fas fa-atom"></i></h3>
                                                    <p class="text-danger" id="co2leveltitle">NIVEAU DE CO2</p>
                                            </div>
                                            <div class="ml-auto">
                                    ...
                                    <div class="d-flex m-b-40 align-items-center no-block">
                                        ...
                                        <div class="ml-auto">
                                            <ul class="list-inline font-12">
                                                <li><i class="fa fa-circle text-danger"></i> Température Ext moyenne: <?php echo number_format(getaverage($tempext), 1); ?> °C</li>
                                                <li><i class="fa fa-circle text-warning"></i> Température Int moyenne: <?php echo number_format(getaverage($tempint), 1); ?> °C</li>
                                            </ul>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex m-b-40 align-items-center no-block">
                                        <h5 class="card-title ">NIVEAU DES GAZES</h5>
                                        <div class="ml-auto">
                                            <ul class="list-inline font-12">
                                                <li><i class="fa fa-circle text-purple"></i> CO2 moyenne: <?php echo number_format(getaverage($co2level), 1); ?> PPM</li>
                                                <li><i class="fa fa-circle text-primary"></i> SB.Gazes moyenne: <?php echo number_format(getaverage($gauzeslevel), 1); ?> PPM</li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex m-b-40 align-items-center no-block">
                                        ...
                                        <div class="ml-auto">
                                            <ul class="list-inline font-12">
                                                <li><i class="fa fa-circle text-success"></i> Humidité moyenne: <?php echo number_format(getaverage($humidityint), 0); ?> %RH</li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex m-b-40 align-items-center no-block">
                                        ...
                                        <div class="ml-auto">
                                            <ul class="list-inline font-12">
                                                <li><i class="fa fa-circle text-info"></i> Flux moyenne: <?php echo number_format(getaverage($luminousflow), 1); ?> LUX</li>
                                            </ul>
                                        </div>
                                    </div>
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if(response.exteriorDoor == 1) {
                            ...
                            document.getElementById('door').innerHTML = "OUVERTE";
                        }
                        else {
                            ...
                            document.getElementById('door').innerHTML = "FERMÉE";
                        }
                        ...
                        if(response.interiorWindow == 1) {
                            ...
                            document.getElementById('window').innerHTML = "OUVERTE";
                        }
                        else {
                            ...
                            document.getElementById('window').innerHTML = "FERMÉE";
                        }
                        ...
                        if(response.movement == 1) {
                            ...
                            document.getElementById('movement').innerHTML = "OUI";
                        }
                        else {
                            ...
                            document.getElementById('movement').innerHTML = "NON";
                        }
